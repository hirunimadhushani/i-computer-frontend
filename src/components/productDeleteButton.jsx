...
.catch(()=>{
    ...
    return(
        <>
       <button onClick={()=>{setIsMessageOpen(true)}} className="bg-red-600 w-[80px] h-[40px] flex justify-center items-center text-white  pg-2 rounded-lg curser-pointer hover:bg-red-700 ">Delete
     </button>
